...
{
    /// <summary>
    /// The page responsible for displaying and controlling the Tawlbwrdd gametype
    /// </summary>
    public sealed partial class TawlbwrddPage : Page
    {
        ...
        private Board board = new Board(11, "Tawlbwrdd");
        ...
        /// <summary>
        /// Constructor for HnefataflPage. Initializes the component, background worker and timers
        /// </summary>
        public TawlbwrddPage()
        {
            InitializeComponent();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            rectArr = new Rectangle[] { A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11,
