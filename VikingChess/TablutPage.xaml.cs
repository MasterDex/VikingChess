...
{
    /// <summary>
    /// The page responsible for displaying and controlling the Tablut gametype
    /// </summary>
    public sealed partial class TablutPage : Page
    {
        ...
        private Board board = new Board(9, "Tablut");
        ...
        /// <summary>
        /// Constructor for TablutPage. Initializes the component, background worker and timers
        /// </summary>
        public TablutPage()
        {
            InitializeComponent();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            rectArr = new Rectangle[] { A1, A2, A3, A4, A5, A6, A7, A8, A9, 
