...
{
    /// <summary>
    /// The page responsible for displaying and controlling the Brandubh gametype
    /// </summary>
    public sealed partial class BrandubhPage : Page
    {
        ...
        private Board board = new Board(7, "Brandubh");
        ...
        // <summary>
        /// Constructor for BrandubhPage. Initializes the component, background worker and timers
        /// </summary>
        public BrandubhPage()
        {
            InitializeComponent();
